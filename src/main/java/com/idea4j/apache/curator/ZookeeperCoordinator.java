...
public class ZookeeperCoordinator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        serverInfo.setPort(20881);

        zookeeperCoordinator.registerRemote(serverInfo);

        zookeeperCoordinator.queryRemoteNodes().forEach(serverInfo1 -> {
            System.out.println(serverInfo.getHost()+":"+serverInfo.getPort());
        });
        Thread.sleep(10000);
